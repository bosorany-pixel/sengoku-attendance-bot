      ...
      >
        ...
        {levelsWithProgress.length === 0 ? (
          ...
          <div className="w-full max-w-md mx-auto">
            <p className="text-dark-textLight text-xs uppercase tracking-wider mb-3 text-center">
              Уровни
            </p>
            ...
            >
              {levelsWithProgress.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`bp-line-segment w-0.5 flex-1 min-h-[0.5rem] ${segAboveWhite ? 'bg-white' : 'bg-dark-border'}`}
                    />
                    ...
                    <div
                      className={`bp-line-segment w-0.5 flex-1 min-h-[0.5rem] ${segBelowWhite ? 'bg-white' : 'bg-dark-border'}`}
                    />
                  </div>
                );
              })}
            ...
            <ul className="relative list-none w-full">
              {levelsWithProgress.map((item, index) => (
                <motion.li
                  ...
                  className={`flex items-center gap-3 h-14 py-0 rounded-lg px-2 -mx-2 transition-colors ${
                      ...
                      className={`inline-flex items-center justify-center rounded-full px-1.5 py-0.5 text-xs font-semibold min-w-[1.25rem] flex-shrink-0 ${
                        item.achieved
                          ...
                          : item.isNextLevel
                            ...
                            : 'bg-dark-border/60 text-dark-textLight'
                      }`}
                    >
                      {item.level}
                    </span>
